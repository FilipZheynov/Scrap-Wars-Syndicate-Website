...
import Invasion from "../../assets/Invasion.webp";
import CapturePoint from "../../assets/CapturePoint.webp";
import BaseBattle from "../../assets/BaseBattle.webp";
    ...
    <section className="w-auto mx-4 md:mx-20 mt-5">
      <div className="w-full flex flex-row flex-wrap gap-5 justify-center">
        ...
        <ScrollReveal>
          <GamemodeShowcase
            image={CapturePoint}
            title="Convoy Assault"
            description="Use your limited vehicles to attack the enemy"
            to="https://docs.google.com/document/d/1DQq3W07TIO1qly5cdp_qE4VoVhEEltuS-qtiT4yoXY0/edit?tab=t.yhn42z2tbtgs#heading=h.ioz2eq7w4iwf"
          />
        </ScrollReveal>
        <ScrollReveal>
          <GamemodeShowcase
