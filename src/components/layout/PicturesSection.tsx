...
export default function PicturesSection() {
  return (
    <section className="mx-10 md:mx-30">
        ...
        <ScrollReveal>
          <div className="group relative w-full h-80 cursor-pointer">
            <div className="absolute inset-0 z-10 transition-all duration-500 ease-out translate-x-4 translate-y-4 rotate-6 group-hover:translate-y-60 group-hover:rotate-12">
              <img
                src={Pic13}
                className="w-full h-full object-cover rounded-xl shadow-md border-2 border-[var(--primary)]"
              />
            </div>
            ...
            <div className="absolute inset-0 z-30 transition-all duration-500 ease-out group-hover:-translate-x-2 group-hover:-translate-y-2">
              <img
                src={Pic1}
                className="w-full h-full object-cover rounded-xl shadow-xl border-2 border-[var(--primary)]"
              />
            </div>
          </div>
        </ScrollReveal>
        <p className="font-texts text-5xl text-[var(--text-secondary)] text-center content-center my-10  mt-15 md:mt-0">
          Alot of maps
        </p>
