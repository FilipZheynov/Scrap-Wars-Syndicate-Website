...
import NormalLoadouts from "../../assets/NormalLoadouts.webp";
import ADLoadouts from "../../assets/ADLoadouts.webp";
  ...
  return (
    <div className="flex flex-col md:flex-row w-full h-[700px] md:h-150 overflow-hidden rounded-xl gap-2">
      ...
      >
        ...
        >
          <h3 className="absolute nowrap font-texts page-subtitle text-white font-bold text-2xl">
            Standard Loadouts
          </h3>
          <p className="text-white/80 mt-25 md:hidden text-sm">
            Tap again to enter
          </p>
        </div>
      </div>
