...
export default function AboutSection() {
  return (
    <section className="mx-4 md:mx-8 lg:mx-12 xl:mx-50 mb-10" >
            ...
            <p className="w-full md:w-3/4 lg:w-1/2 mt-4 text-sm md:text-base">Scrap Wars Syndicate is a community, which connects players all around to world to participate in Scrap Mechanic Battles and encourages creating and developing</p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 my-5">
                ...
                <Card image={Ammo} title="Realism" description="Realism is a crucial part of the battles"/>
                <Card image={Baguette} title="Respect" description="Respect everyone except vanilla players"/>
                <Card image={STG} title="Fair Game" description="Keep the game fair, follow the rules"/>
            </div>
    </section>
  );
}
